    ...
    <div className="mx-auto max-w-2xl px-6 py-10 space-y-6">
      ...
      <div className="rounded-xl border border-border p-5 flex items-start justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">
            When on, characters only know each other&apos;s names after being introduced in a scene
            — strangers are referred to by appearance until a name is spoken or revealed. When off,
            every character knows every other character&apos;s name from the start.
          </p>
        </div>
        <Switch
          disabled={!loaded}
